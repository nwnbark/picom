...
win_maybe_options_fold(struct window_maybe_options upper, struct window_maybe_options lower) {
	struct window_maybe_options ret = {
	    ...
	    .shadow_color.red = !safe_isnan(upper.shadow_color.red) ? upper.shadow_color.red : lower.shadow_color.red,
	    .shadow_color.green = !safe_isnan(upper.shadow_color.green) ? upper.shadow_color.green : lower.shadow_color.green,
	    .shadow_color.blue = !safe_isnan(upper.shadow_color.blue) ? upper.shadow_color.blue : lower.shadow_color.blue,
...
win_maybe_options_or(struct window_maybe_options maybe, struct window_options def) {
	...
	struct window_options ret = {
	    ...
	    .shadow_color.red = !safe_isnan(maybe.shadow_color.red) ? maybe.shadow_color.red : def.shadow_color.red,
	    .shadow_color.green = !safe_isnan(maybe.shadow_color.green) ? maybe.shadow_color.green : def.shadow_color.green,
	    .shadow_color.blue = !safe_isnan(maybe.shadow_color.blue) ? maybe.shadow_color.blue : def.shadow_color.blue,
